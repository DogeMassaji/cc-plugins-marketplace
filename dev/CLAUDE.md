...
agents/                    # 自定义 Agent 定义
commands/                  # Slash Command（/popping, /locking, /breaking 三模式 + /spec, /plan, /build, /review, /check, /fix, /re-review, /doc）
...
**Build:** dev:incremental-implementation, dev:api-doc-generator, dev:backend-test-generator
**Review:** dev:code-review-and-quality, dev:security-and-hardening
**Meta:** dev:using-agent-skills, dev:git-commit
